...
const LAUNCHER_CATEGORIES: LauncherCategory[] = [
  {
    ...
    items: [
      ...
      { key: 'approvals', emoji: '\u2714\uFE0F', label: 'Approvals', labelAr: '\u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0627\u062A', path: '/admin/approvals', roles: ['admin', 'engineer'] },
      { key: 'my-work-plan', emoji: '\u{1F4CB}', label: 'My Work Plan', labelAr: '\u062E\u0637\u0629 \u0639\u0645\u0644\u064A', path: '/my-work-plan', roles: ['inspector', 'specialist', 'engineer', 'maintenance'] },
      { key: 'my-assignments', emoji: '\u{1F4CB}', label: 'My Assignments', labelAr: '\u0645\u0647\u0627\u0645\u064A', path: '/inspector/assignments', roles: ['inspector', 'specialist', 'maintenance'] },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'readings-cleanup', emoji: '\u{1F9F9}', label: 'Reading Cleanup', labelAr: '\u062A\u0635\u062D\u064A\u062D \u0627\u0644\u0642\u0631\u0627\u0621\u0627\u062A', path: '/admin/readings-cleanup', roles: ['admin'] },
...
const ROUTE_LABELS: Record<string, string> = {
  ...
  'running-hours': 'Running Hours', 'readings-cleanup': 'Reading Cleanup',
